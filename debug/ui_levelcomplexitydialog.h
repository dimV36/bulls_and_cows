...
public:
    ...
    QHBoxLayout *standart_box_layout_;
    ...
    void setupUi(QDialog *LevelComplexityDialog)
    {
        ...
        LevelComplexityDialog->resize(365, 176);
        ...
        standart_box_layout_ = new QHBoxLayout();
        standart_box_layout_->setObjectName(QStringLiteral("standart_box_layout_"));
        horizontalSpacer = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        standart_box_layout_->addItem(horizontalSpacer);

        button_box_ = new QDialogButtonBox(LevelComplexityDialog);
        button_box_->setObjectName(QStringLiteral("button_box_"));
        button_box_->setLayoutDirection(Qt::RightToLeft);
        button_box_->setAutoFillBackground(false);
        ...
        standart_box_layout_->addWidget(button_box_);


        gridLayout->addLayout(standart_box_layout_, 2, 0, 1, 1);
